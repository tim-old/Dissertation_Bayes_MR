...
data {
  ...
  // int < lower=0, upper=1 > Y[N]; // uncomment for logistic regression
...
parameters {
  real <lower=0> sigma_y; // uncomment for linear regression
...
model {
  ...
  // Y ~ bernoulli_logit(intercept_y + X_u * beta_u + Z * beta + Xpred * theta); // uncomment for logistic regression
