...
\multicolumn{13}{>{\raggedright}m{\dimexpr 6.03in+24\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{CI:\ Confidence\ Interval,\ IV:\ Instumental\ Variable,\ SE:\ Standard\ Error.\ Null\ Causal\ Effect\ (β\ =\ 0)}}}} \\
...
\leavevmode\newline There were missing gene-outcome coefficients for three instruments from Xie et al\textsuperscript{\citeproc{ref-xie_associations_2023}{9}}, and one instrument in Clift et al\textsuperscript{\citeproc{ref-clift_smoking_2022}{10}} was reported as having an implausibly large gene-outcome coefficient/standard error (-1243.03 and 19161.64, respectively); these were imputed as the respective mean value per study. Data were otherwise complete as expected per the descriptions in each study manuscript. A summary of the re-analysis results is presented in Table \ref{tab:citations-reanalysis-summ-display}; estimates are presented both as \(\beta\) regression coefficients and \hyperref[acronyms_OR]{odds ratio (OR)}s to aid comparison across studies.

\paragraph{Re-analysis vs Reported WME Causal Estimates}\label{re-analysis-vs-reported-wme-causal-estimates}

\leavevmode\newline Three \hyperref[acronyms_WME]{WME} estimates generated through re-analysis matched the originally reported estimates poorly. There was a \textgreater0.1 difference in re-analysis estimates of \hyperref[acronyms_OR]{OR} or \(\beta\) versus the values originally reported by Carreras-Torres et al\textsuperscript{\citeproc{ref-carreras-torres_role_2017}{6}}, Ligthart et al\textsuperscript{\citeproc{ref-ligthart_genome_2018}{3}} and Mokry et al\textsuperscript{\citeproc{ref-mokry_obesity_2016}{5}}. Details of instruments used in re-analysis were re-checked against the relevant manuscripts to ensure no transcription errors had occurred. Re-analysed \hyperref[acronyms_WME]{WME} \hyperref[acronyms_CI]{CI}s were notably wider than reported values for Budu-Aggrey et al\textsuperscript{\citeproc{ref-budu-aggrey_evidence_2019}{8}}, Carreras-Torres et al\textsuperscript{\citeproc{ref-carreras-torres_role_2017}{6}}, Ligthart et al\textsuperscript{\citeproc{ref-ligthart_genome_2018}{3}}, and Mokry et al\textsuperscript{\citeproc{ref-mokry_obesity_2016}{5}}

Overall, estimates and \hyperref[acronyms_CI]{CI}s from re-analysis of the other six studies (Carter et al\textsuperscript{\citeproc{ref-carter_understanding_2019}{4}}, Choi et al\textsuperscript{\citeproc{ref-choi_assessment_2019}{1}}, Clift et al\textsuperscript{\citeproc{ref-clift_smoking_2022}{10}}, Pasman et al\textsuperscript{\citeproc{ref-pasman_gwas_2018}{2}}, Xie et al\textsuperscript{\citeproc{ref-xie_associations_2023}{9}}, and Xu et al\textsuperscript{\citeproc{ref-xu_causal_2022}{7}}) appeared comparable to reported values, after accounting for rounding errors from published summary data, and random variation inherent in bootstrap generation of \hyperref[acronyms_CI]{CI}s.

Compared with reported values, the mean difference for effect estimates (\hyperref[acronyms_SE]{SE}, 95\% \hyperref[acronyms_CI]{CI}s) from the was 0(00.002to-0.002).

Conclusions regarding presence of a causal effect were consistent: reported \hyperref[acronyms_WME]{WME}, re-analysed \hyperref[acronyms_WME]{WME} estimates were concordant in detecting a causal exposure-outcome effect in

\paragraph{Re-analysis WME vs MR-Hevo Causal Estimates}\label{re-analysis-wme-vs-mr-hevo-causal-estimates}

\leavevmode\newline Across all ten studies re-analysed (Table \ref{tab:citations-reanalysis-summ-display}), a causal effect was reported by MR-Hevo in 5 and by \hyperref[acronyms_WME]{WME} in 5; causal reporting was discordant in 0
...
\begin{description}
\tightlist
\item[\phantomsection\label{acronyms_BMI}{BMI}]
body mass index
...
\item[\phantomsection\label{acronyms_NAFLD}{NAFLD}]
...
\item[\phantomsection\label{acronyms_T2DM}{T2DM}]
