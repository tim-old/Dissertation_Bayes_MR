...
# Load data
causal_20k_point0_scen3_models <- readRDS(file = here("MSc_Thesis_Split", "Data", "Simulated_Datasets", "causal_20k_point0_scen3_models.rds"))
...
# Generate rows
causal_20k_point0_scen3 <- get_summary_MR_tib_row(causal_20k_point0_scen3_models[1:n])
saveRDS(causal_20k_point0_scen3, file = here("MSc_Thesis_Split", "Data", "Summary_Tables", "causal_20k_point0_scen3_row.rds"))
...
# Combine rows
causal_20k_scen3_sim_summ_tib <- bind_rows(causal_20k_point0_scen3,
                                           causal_20k_point1_scen3,
