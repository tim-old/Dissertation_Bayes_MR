...
# Load datasets
load(here("MSc_Thesis_Split", "Data", "simulated_datasets_models.RData"))
...
foo <- no_causal_10k_point1_scen1_models[1:5]

#no_causal_tenk_point1_scen1 <- get_summary_MR_tib_row(no_causal_tenk_point1_scen1_models)
no_causal_tenk_point1_scen1 <- get_summary_MR_tib_row(foo)
...
scen1_sim_summ_tib %>%
  ...
  column_spec(column = c(1:8), 
              width = c("0.5cm", "2cm", "0.75cm", "0.75cm", "3.5cm", "3cm", "3.5cm", "3cm"), 
              italic = c(FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE))
