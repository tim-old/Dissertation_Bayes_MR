...
# Load datasets
all_sim_data_models <- readRDS(file = here("MSc_Thesis_Split", "Data", "simulated_datasets_models.rds"))
...
foo <- all_sim_data_models$no_causal_10k_point1_scen1_models[1:5]
