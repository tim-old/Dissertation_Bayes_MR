...
Citations_Instrument_Data <- read.csv(here("MSc_Thesis_Split", "Data", "Citations_Datasets", "Citations_Instrument_Data.csv")) %>% as.tibble() %>% mutate(N=1)
Citations_Instrument_Data_2 <- read.csv(here("MSc_Thesis_Split", "Data", "Citations_Datasets", "Citations_Instrument_Data.csv")) %>% as.tibble()%>% mutate(N=2)
...
reanalysis_tib <- get_reanalysis_tib(Data_List) %>% mutate(citation = "[@bowden_consistent_2016]") #%>% kable()
