...
```{r data-sim-validation, include=TRUE, fig.height=8}
#| fig.id = "data-sim-validation",
#| fig.cap = "Plots of a representative simulated dataset; all plots shown simulate genetic instruments from the same index from the same random seed. Left and right columns demonstrate null and positive true causal effects (\U03B2 = 0 and \U03B2 = 0.1), respectively. The proportion of invalid genetic instruments, i.e. those with pleiotropic effects, increases 10% each row. Plots a) and b) ...."
