...
A total of *** abstracts and *** full texts were screened to identify the 10 studies listed in Table \@ref(tab:citation-search-sample); the screening flow diagram is presented in Figure \@ref(fig:screening_flow).
...
```{r citations-reanalysis-summ-tib, cache=TRUE}
...
```{r citation-search-sample, include=TRUE, cache=TRUE}
