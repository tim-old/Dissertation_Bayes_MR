...
get_summary_MR_tib_row <- function(n_participants = 1000,          # update to 10,000 for final
  ...
  output_tib_row <- results_tib %>% 
    summarise(N = N_datasets,
              ...
              Hevo_Av = NA, #mean(Hevo_est),
              Hevo_SE = NA, #mean(Hevo_se),
              Hevo_Pos_Rate = NA, #length(Hevo_pval[Hevo_pval < 0.05]) / N_datasets
    ) %>% 
...
set.seed(14101583)
test_tib_summ_MR <-  get_summary_MR_tib_row(n_participants = 1000,
                                            n_instruments = 25,
                                            n_datasets = 200,
                                            prop_invalid = 0.1,
                                            beta_val = 0.1,
