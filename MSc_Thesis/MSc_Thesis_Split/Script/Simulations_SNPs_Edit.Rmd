...
extract_models_XY <- function(sim){
  ...
  # for gene:exposure association (beta_X_G) and gene:outcome
  # association (beta_Y_G)
...
set.seed(1701)
sim_test_data_X <- wme_model_sim(n_participants = 10000,
                                 n_instruments = 25,
                                 n_datasets = 10,
                                 prop_invalid = 0.1,
                                 causal_effect = TRUE,
...
test_plot_tib_X <- extract_models_XY(sim_test_data_X)[[1]] 
  
test_plot_tib_X

# Check gene:exposure coefficients approximate true
# values
test_plot_tib_X %>% 
...
# Check gene:outcome coefficients approximate pleiotropic
# effects when no causal effect present
set.seed(1701)
sim_test_data_Y <- wme_model_sim(n_participants = 10000,
                                 n_instruments = 25,
                                 n_datasets = 10,
                                 prop_invalid = 0.3,
                                 causal_effect = FALSE,
...
test_plot_tib_Y <- extract_models_XY(sim_test_data_Y)[[1]]
