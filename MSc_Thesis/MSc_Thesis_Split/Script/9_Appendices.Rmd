...
simulate_MR_data <- function(n_participants = as.integer(), 
  ...
  ifelse(two_sample == FALSE,
         sample_2_ref <- sample_1_ref,
         sample_2_ref <- (n_participants+1):(2*n_participants))
...
set.seed(170)
sim_test_data_causal_2 <- simulate_MR_data(n_participants = 1000,
                                           n_instruments = 100,
                                           n_datasets = 1,
                                           prop_invalid = 0.3,
                                           causal_effect = TRUE,
...
plot_GY_GX(test_plot_tib_causal_2, plot_title = "Causal Effect Present")
...
# mr.sstats.stanmodel <- stan_model(file= here("MRHevo_summarystats.stan"),
...
time_standard <- system.time(get_summary_MR_tib_row(n_participants = 10000,
                                                    n_instruments = 25,
                                                    n_datasets = 5,
                                                    prop_invalid = 0.1,
                                                    beta_val = 0.1,
...
time_precomp <- system.time(get_summary_MR_tib_row(n_participants = 10000,
                                                    n_instruments = 25,
                                                    n_datasets = 5,
                                                    prop_invalid = 0.1,
                                                    beta_val = 0.1,
...
cat("Precomp: ", tib_time_precomp)

```



```{r test-summary-MR-tib-row-fn}
...
```{r no-causal-tenk-point1-scen1, echo=FALSE, warning=FALSE, cache=TRUE}
...
```{r no-causal-tenk-point2-scen1, echo=FALSE, warning=FALSE, cache=TRUE}
...
```{r scen1-sim-summ-tib, echo=FALSE, warning=FALSE, cache=TRUE}
