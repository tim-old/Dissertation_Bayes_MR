...
simulate_MR_data <- function(n_participants = as.integer(), 
  ...
  ifelse(two_sample == FALSE,
         sample_2_ref <- sample_1_ref, # same participant indices for outcome + exposure - 1 sample MR
         sample_2_ref <- (n_participants+1):(2*n_participants)) # change participant indices for outcome + exposure - 2 sample MR
