...
## Appendix B: Simulation Code {#appendix-sim}
...
# Causal effect not present
#set.seed(1701)
sim_test_data_causal_0_2SMR <- get_simulated_MR_data(n_participants = 10000,
                                                     n_instruments = 100,
                                                     n_datasets = 1,
                                                     prop_invalid = 0,
                                                     causal_effect = FALSE,
...
# Causal effect present
#set.seed(1701)
sim_test_data_causal_1_2SMR <- get_simulated_MR_data(n_participants = 10000,
                                                     n_instruments = 100,
                                                     n_datasets = 1,
                                                     prop_invalid = 0,
                                                     causal_effect = TRUE,
...
```{r test-summary-MR-tib-row-fn-2, include=FALSE}


#set.seed(14101583)
test_tib_summ_MR_data_2 <-  get_simulated_MR_data(n_participants = 10000,
                                                  n_instruments = 25,
                                                  n_datasets = 2,
                                                  prop_invalid = 0.2,
                                                  beta_val = 0.1,
...
test_tib_summ_MR_models_2 <- get_models(test_tib_summ_MR_data_2)

test_tib_summ_MR_row_2 <- get_summary_MR_tib_row(test_tib_summ_MR_models_2)

test_tib_summ_MR_row_2
...
# # Causal effect present
# set.seed(14101583)
# sim_test_data_causal_2 <- get_simulated_MR_data(n_participants = 100000,
#                                            n_instruments = 25,
#                                            n_datasets = 1,
#                                            prop_invalid = 0.3,
...
# 
# test_plot_tib_causal_2 <- get_models(sim_test_data_causal_2)[[1]]
# 
...
<!-- ### Programmatic Creation of Datasets -->

<!-- The above functions were then used, first to generate 1000 datasets for each scenario: -->

```{r create-MR-dataset-script, echo=FALSE}
...
# # Set inputs
# 
# MR_dataset_inputs <- list(n_datasets = 1,
#                             prop_invalid = list("zero" = 0,
#                                                 "point1" = 0.1,
#                                                 "point2" = 0.2,
#                                                 "point3" = 0.3),
#                             n_participants = list("10k" = 10, 
#                                                   "20k" = 20),
#                             n_instruments =  25,
#                             
#                             causal_effect = list("causal" = TRUE,
#                                                  "no_causal" = FALSE),
#                             
#                             balanced_pleio = list("scen1" = TRUE,
#                                                   "scen2" = FALSE,
#                                                   "scen3" = FALSE),
#                             
#                             InSIDE_satisfied = list("scen1" = TRUE,
#                                                     "scen2" = TRUE,
#                                                     "scen3" = FALSE)
#                             )
# 
# MR_dataset_name <- function(input){
#   
#   pmap(input, paste0)
# }
...
# 
# foo <- pmap(MR_dataset_inputs, get_simulated_MR_data)
# 
# 
# 
# 
...
#here("MSc_Thesis_Split", "Data", "Simulated_Datasets")

# foo <- pmap(list(1, n_instruments, n_datasets), get_simulated_MR_data)
# 
# str(foo)
...
# bar <- tibble(n = 100, mean = list("a" = 5, "b" = 10), sd = 0.1)
# pmap(bar, rnorm)
# 
# n_datasets <- 3
# 
...
# iwalk(mtcars, \(col, value) cat(value, ": ", median(col), "\n", sep = ""))
# 
# mtcars
