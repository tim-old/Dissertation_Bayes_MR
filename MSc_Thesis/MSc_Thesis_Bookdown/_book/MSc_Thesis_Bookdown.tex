...
The typical process for ``bootstrap'' generating an estimate, \hyperref[acronyms_SE]{SE} and \hyperref[acronyms_CI]{CI}s of a population parameter (e.g.~population mean \(\mu\)) from a sample \(x\) is as follows\textsuperscript{\citeproc{ref-buscaglia_chapter_2020}{35}}:
...
\item
  The set of \(k\) statistics are combined to form a ``bootstrap distribution''; as expected from \hyperref[acronyms_CLT]{central limit theorem (CLT)}\textsuperscript{\citeproc{ref-ross_chapter_2014}{36}}, this is typically closer to a normal distribution than the underlying distribution of values in either the bootstrap population \(x\) or the total population \(X\). (See Figure \ref{fig:prostate-vol} for an example of this)
\item
...
This work was completed using R version 4.4.3\textsuperscript{\citeproc{ref-base}{21}} with the following R packages: acronymsdown v. 0.11.1\textsuperscript{\citeproc{ref-acronymsdown}{39}}, bookdown v. 0.43\textsuperscript{\citeproc{ref-bookdown2016}{40},\citeproc{ref-bookdown2025}{41}}, car v. 3.1.3\textsuperscript{\citeproc{ref-car}{42}}, cowplot v. 1.1.3\textsuperscript{\citeproc{ref-cowplot}{43}}, crayon v. 1.5.3\textsuperscript{\citeproc{ref-crayon}{44}}, devtools v. 2.4.5\textsuperscript{\citeproc{ref-devtools}{45}}, flextable v. 0.9.9\textsuperscript{\citeproc{ref-flextable}{46}}, ftExtra v. 0.6.4\textsuperscript{\citeproc{ref-ftExtra}{47}}, ggdag v. 0.2.13\textsuperscript{\citeproc{ref-ggdag}{48}}, gghighlight v. 0.4.1\textsuperscript{\citeproc{ref-gghighlight}{49}}, gluedown v. 1.0.9\textsuperscript{\citeproc{ref-gluedown}{50}}, grateful v. 0.2.12\textsuperscript{\citeproc{ref-grateful}{51}}, grid v. 4.4.3\textsuperscript{\citeproc{ref-grid}{52}}, here v. 1.0.1\textsuperscript{\citeproc{ref-here}{53}}, infer v. 1.0.8\textsuperscript{\citeproc{ref-infer}{54}}, kableExtra v. 1.4.0\textsuperscript{\citeproc{ref-kableExtra}{55}}, knitr v. 1.50\textsuperscript{\citeproc{ref-knitr2014}{56}--\citeproc{ref-knitr2025}{58}}, matrixStats v. 1.5.0\textsuperscript{\citeproc{ref-matrixStats}{59}}, medicaldata v. 0.2.0\textsuperscript{\citeproc{ref-medicaldata}{38}}, officer v. 0.6.10\textsuperscript{\citeproc{ref-officer}{60}}, parallel v. 4.4.3\textsuperscript{\citeproc{ref-parallel}{61}}, rmarkdown v. 2.29\textsuperscript{\citeproc{ref-rmarkdown2018}{62}--\citeproc{ref-rmarkdown2024}{64}}, rstan v. 2.32.7\textsuperscript{\citeproc{ref-rstan}{65}}, tables v. 0.9.31\textsuperscript{\citeproc{ref-tables}{66}}, tidyverse v. 2.0.0\textsuperscript{\citeproc{ref-tidyverse}{23}}, TwoSampleMR v. 0.6.16\textsuperscript{\citeproc{ref-TwoSampleMR2017}{67},\citeproc{ref-TwoSampleMR2018}{68}}, wordcountaddin v. 0.3.0.9000\textsuperscript{\citeproc{ref-wordcountaddin}{69}}.
...
RAM: \ensuremath{1.69071\times 10^{10}}
